...
#I separated my configuration into separate file config.py

#----------------------------------------------------------------------------#
# Models.
#----------------------------------------------------------------------------#

#I separated my models into separate file models.py
...
def delete_venue(venue_id):
  # Completed  endpoint for taking a venue_id
    try:
...
def edit_artist_submission(artist_id):
  #takeing values from the form submitted
...
@app.route('/shows')
def shows():
#replaceing with real venues data.
